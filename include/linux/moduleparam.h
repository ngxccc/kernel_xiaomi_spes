...
#define __MODULE_INFO(tag, name, info)                                         \
	static const char __UNIQUE_ID(name)[] __used                           \
...
#define __module_param_call(prefix, name, ops, arg, perm, level, flags)        \
	...
	static struct kernel_param __moduleparam_const __param_##name __used   \
		__attribute__((unused, __section__("__param"),                 \
			       aligned(sizeof(void *)))) = {                   \
			__param_str_##name,                                    \
			THIS_MODULE,                                           \
			ops,                                                   \
			VERIFY_OCTAL_PERMISSIONS(perm),                        \
			level,                                                 \
			flags,                                                 \
			{ arg }                                                \
		}
...
#define module_param_call(name, _set, _get, arg, perm)                         \
	...
	__module_param_call(MODULE_PARAM_PREFIX, name, &__param_ops_##name,    \
			    arg, perm, -1, 0)
...
#define module_param_string(name, string, len, perm)                           \
	static const struct kparam_string __param_string_##name = { len,       \
								    string };  \
...
#define module_param_array_named(name, array, type, nump, perm)                \
	...
	__module_param_call(MODULE_PARAM_PREFIX, name, &param_array_ops,       \
